  ...
  head: () => ({
    meta: [
      { title: "Contact Support — founders.click Help" },
      {
        name: "description",
        content:
          "Get in touch with the founders.click support team. We typically reply within 1 business day.",
      },
      ...
      {ticketId ? (
        <div className="mt-8 rounded-lg border border-green-500/30 bg-green-500/5 p-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Your ticket ID is <code className="text-foreground font-mono text-xs">{ticketId}</code>.
